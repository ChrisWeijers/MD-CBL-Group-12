...
qual_2011_mapped = pd.merge(qual_2011, mapping, on='LSOA code 2011', how='left')
qual_2011_mapped["Year"] = 2011
qual_2011_mapped["Month"] = 1  # Assuming January for the month

# Define the list of qualification columns to process
qual_cols = [
    'No qualifications (%)',
...
data_US = qual_2011_mapped[qual_2011_mapped["Change Indicator"].isin(["U", "S"])]
data_US_reduced = data_US[["LSOA code 2021", "Year", "Month"] + qual_cols].copy()

# Rows with indicator "M - Merged"
data_M = qual_2011_mapped[qual_2011_mapped["Change Indicator"] == "M"]
...
# Join the combined qualifications data with the baseline and clean it up
qual_2011_finalized = pd.merge(baseline, combined_quals, on=["LSOA code 2021", "Year", "Month"], how="left")
...
qual_2021 = qual_2021.rename(columns={
    ...
    'Level 4 qualifications or above': 'Level 4+ qualifications (%)',
    'Other qualifications': 'Other qualifications (%)'
})
qual_2021 = qual_2021.drop(columns=['LSOA name 2021'], errors='ignore')
qual_2021["Year"] = 2021
qual_2021["Month"] = 1  # Assuming January for the month

# Join the 2021 qualifications data with the finalized 2011 data
q2011 = qual_2011_finalized.set_index(["LSOA code 2021", "Year", "Month"])
q2021 = qual_2021.set_index(["LSOA code 2021", "Year", "Month"])
q2011.update(q2021)
qual_2011_2021_finalized = q2011.reset_index()
