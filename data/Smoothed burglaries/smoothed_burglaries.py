...
exp_long_12 = (
    ...
    .melt(id_vars="index", var_name="LSOA code 2021", value_name="Smoothed burglaries (12 months)")
...
exp_long_6 = (
    ...
    .melt(id_vars="index", var_name="LSOA code 2021", value_name="Smoothed burglaries (6 months)")
    .rename(columns={"index": "date"})
)
...
exp_long_3 = (
    ...
    .melt(id_vars="index", var_name="LSOA code 2021", value_name="Smoothed burglaries (3 months)")
    .rename(columns={"index": "date"})
)
...
exp_long_all = exp_long_12.merge(
    exp_long_6[["date", "LSOA code 2021", "Smoothed burglaries (6 months)"]],
...
exp_long_all = exp_long_all.merge(
    exp_long_3[["date", "LSOA code 2021", "Smoothed burglaries (3 months)"]],
    on=["date", "LSOA code 2021"],
    how="left",
)
...
merged = baseline.merge(
    exp_long_all[
        ["LSOA code 2021", "Year", "Month", "Smoothed burglaries (12 months)",
         "Smoothed burglaries (6 months)", "Smoothed burglaries (3 months)"]
    ],
...
cols = ["Smoothed burglaries (12 months)", "Smoothed burglaries (6 months)", "Smoothed burglaries (3 months)"]
merged.loc[mask, cols] = np.nan

# Round the smoothed expected values to 2 decimal points
merged["Smoothed burglaries (12 months)"] = merged["Smoothed burglaries (12 months)"].round(2)
merged["Smoothed burglaries (6 months)"] = merged["Smoothed burglaries (6 months)"].round(2)
merged["Smoothed burglaries (3 months)"] = merged["Smoothed burglaries (3 months)"].round(2)
...
plot_gdf_2d["Smoothed burglaries (12 months)"] = plot_gdf_2d["Smoothed burglaries (12 months)"].fillna(0.0)

fig, ax = plt.subplots(figsize=(10, 10))
plot_gdf_2d.plot(
    column="Smoothed burglaries (12 months)",
    ax=ax,
    cmap="OrRd",
    legend=True,
...
z = plot_gdf_2d["Smoothed burglaries (12 months)"].values
